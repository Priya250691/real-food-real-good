<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="JayBhavaniLocho.ResetPassword" %>
...
<body>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-6 bg-dark d-flex align-items-center">
                <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <h1 class="text-white mb-4">Forgot Password Change</h1>
                    <form id="form1" runat="server">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div id="newPasswordError" class="text-danger" runat="server"></div>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <div id="confirmPasswordError" class="text-danger" runat="server"></div>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-12">
                                <asp:Button ID="btnReset" runat="server" Text="Reset" OnClick="btnReset_Click" CssClass="btn btn-primary" OnClientClick="return validateForm();" />
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-12">
    ...
    <script type="text/javascript">
        ...
        var newPasswordError = document.getElementById('<%= newPasswordError.ClientID %>');
        var confirmPasswordError = document.getElementById('<%= confirmPasswordError.ClientID %>');
