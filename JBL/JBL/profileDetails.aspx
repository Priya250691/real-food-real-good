<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profileDetails.aspx.cs" Inherits="JayBhavaniLocho.profileDetails" %>
        ...
        function checkLoggedIn() {
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Profile Details</h1>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-6 bg-dark d-flex align-items-center">
                <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <h1 class="text-white mb-4" style="margin-left:100px;"><%= Session["Username"] %>'s Profile</h1>
