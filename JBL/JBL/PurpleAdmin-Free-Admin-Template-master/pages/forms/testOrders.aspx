<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="testOrders.aspx.cs" Inherits="JBL.PurpleAdmin_Free_Admin_Template_master.pages.forms.testOrders" %>
          ...
          <script>
              ...
              $(document).ready(function () {
                  if ($.fn.DataTable) {
                      ...
                      console.error("DataTables library is not loaded or not properly initialized.");
                  }
              });
