<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="staff_list.aspx.cs" Inherits="JBL.PurpleAdmin_Free_Admin_Template_master.pages.forms.staff_list" %>
          ...
          <div class="main-panel">
              <div class="content-wrapper">
                  ...
                  <div class="row">
                      ...
                      <div class="card">
                          <div class="card-body">
                              <h4 style="text-align: center;">View Staff</h4>
                              <p class="card-description"></p>
                               <form id="form1" runat="server">
        <div class="container">
            <h2>Staff List</h2>
            <asp:GridView ID="GridViewStaff" runat="server" AutoGenerateColumns="false" CssClass="gridview">
                <Columns>
...
#categoryGridView {
    ...
    #categoryGridView tr:nth-child(odd) {
        background-color: #968f8f;
    }

    #categoryGridView tr:nth-child(even) {
