<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="generateReport.aspx.cs" Inherits="JBL.PurpleAdmin_Free_Admin_Template_master.pages.forms.generateReport" %>
...
<body>
    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="container">
            <h1>Order Report</h1>
            <asp:Button ID="btnDownloadReport" runat="server" CssClass="btn-download" Text="Download Report" OnClick="btnDownloadReport_Click" />
        </div>
    </form>
                          </div>
                      </div>
