<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addCategory.aspx.cs" Inherits="JayBhavaniLocho.PurpleAdmin_Free_Admin_Template_master.pages.forms.addCategory"  %>
          ...
          <div class="main-panel">
              <div class="content-wrapper">
                  ...
                  <div class="row">
                      ...
                      <div class="card">
                          <div class="card-body">
                              <h4 class="card-title" style="margin-left: 500px;">Add Category form</h4>
                              <p class="card-description"></p>
                              <form class="forms-sample" runat="server" onsubmit="return submitForm()">
                                  <div class="form-group">
                                      <label for="exampleInputUsername1">Category Name</label>
                                      <asp:TextBox runat="server" ID="categoryNameTextBox" CssClass="form-control" placeholder="Category Name" required />
                                  </div>
                                  <div class="form-group">
                                      <label for="exampleFormControlSelect1">Status</label>
                                      <%--<asp:DropDownList runat="server" ID="statusDropDown" CssClass="form-control form-control-lg">
                                  ...
                                  <asp:Button runat="server" Text="Add Category" CssClass="btn btn-gradient-primary me-2" OnClick="AddCategory_Click" required />
                                  <button type="button" class="btn btn-light" onclick="cancelForm()">Cancel</button>

                                  <!-- Display the inserted data -->
                                  <div class="card">
                                      <div class="card-body">
                                          <h4 class="card-title">Inserted Category</h4>
                                          <asp:GridView ID="categoryGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="categoryId"
                                              OnRowEditing="categoryGridView_RowEditing" OnRowUpdating="categoryGridView_RowUpdating"
                                              OnRowCancelingEdit="categoryGridView_RowCancelingEdit" OnRowDeleting="categoryGridView_RowDeleting">
                                              <Columns>
                      ...
                      <script>
                          // Function to show alert when clicking on the "Add Category" button
                          //function showAlertOnAddCategory() {
